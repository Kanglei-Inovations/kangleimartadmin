      ...
      body: WillPopScope(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ProductDetailImageSlider(product: product, selectedProductImage: imagecontroller.selectedProductImage,),
                        ...
                        Row(
                          children: [
                            ...
                            Obx(() {
                              ...
                              else product.productType == ProductType.single.toString() && product.salesPrice > 0; {
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 16, color: productcontroller.Status(product.stock) ),
                        ),
                      ],
                    ),
        //Brand ..............................................
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    CachedNetworkImage(imageUrl: controller.selectedVariation.value.image, width: 100,)
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            if (controller.selectedVariation.value.price > 0)
                                            Text('₹. ${controller.getVariationPrice()}  ', style: TextStyle(fontSize: 14,decoration: TextDecoration.lineThrough, ),),
                                            Text('₹. ${controller.getVariationSalesPrice()}', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),)
                                          ],
                                        ),
                                        Row(
                                          children: [
